// Sample JSON data for Wilayas and Communes
const wilayas = [
...
function getWilayaById(wilayaId) {
  return wilayas.find(wilaya => wilaya.id === wilayaId) || null;
}

// Get Commune by ID
function getCommuneById(communeId) {
  return communes.find(commune => commune.id === communeId) || null;
}

// Get Communes by Wilaya ID
function getCommunesByWilaya(wilayaId) {
  return communes.filter(commune => commune.wilaya_id === wilayaId);
}

// Get Wilaya Name by ID
function getWilayaNameById(wilayaId) {
  const wilaya = getWilayaById(wilayaId);
  return wilaya ? wilaya.name : null;
}

// Get Commune Name by ID
function getCommuneNameById(communeId) {
...
function getCommunesByWilayaCode(code) {
...
function getCommunesByName(name) {
  return communes.filter(commune => commune.name.toLowerCase().includes(name.toLowerCase()));
}

// Get Wilayas by Name
function getWilayasByName(name) {
  return wilayas.filter(wilaya => wilaya.name.toLowerCase().includes(name.toLowerCase()));
}

// Get Commune by Postal Code
function getCommuneByPostCode(postCode) {
  return communes.find(commune => commune.post_code === postCode) || null;
}

// Get Wilaya by Postal Code
function getWilayaByPostCode(postCode) {
  const commune = getCommuneByPostCode(postCode);
  return commune ? getWilayaById(commune.wilaya_id) : null;
}

// Get Communes by Postal Code Range (e.g., "0100x")
function getCommunesByPostCodeRange(postCodePrefix) {
  return communes.filter(commune => commune.post_code.startsWith(postCodePrefix));
}

// Get Wilaya Name by Postal Code
function getWilayaNameByPostCode(postCode) {
...
module.exports = {
    ...
    getCommunesByName,
    getWilayasByName,
    getCommuneByPostCode,
    getWilayaByPostCode,
    getCommunesByPostCodeRange,
    getWilayaNameByPostCode
  };